...
const MainLayout = () => {
  ...
  return (
    ...
    <div className="flex h-screen w-full bg-gray-50 overflow-hidden">
      ...
      <div
        className={`flex flex-1 flex-col min-w-0 transition-all duration-300 ease-in-out ${isMobileMenuOpen ? 'ml-64' : 'ml-0'} lg:ml-64`}
      >
        ...
        <header className="bg-gradient-to-r from-primary to-primary-dark text-white p-4 shadow-lg z-20 flex-shrink-0">
          <div className="flex items-center justify-between max-w-full px-2 sm:px-4">
            ...
            <div
              className={`${isLargeScreen || isMobileMenuOpen ? 'hidden' : 'flex'} items-center`}
            >
              <button
