...
// Add Member Icon
export const AddMemberIcon = ({ className = "w-5 h-5" }) => (
  <svg className={className} fill="none" stroke="currentColor" viewBox="0 0 24 24" style={{width: '1em', height: '1em', display: 'inline', verticalAlign: 'middle'}}>
...
// Bulk Upload Icon
export const BulkUploadIcon = ({ className = "w-5 h-5" }) => (
  <svg className={className} fill="none" stroke="currentColor" viewBox="0 0 24 24" style={{width: '1em', height: '1em', display: 'inline', verticalAlign: 'middle'}}>
...
export const AccountStatementIcon = ({ className = "w-5 h-5" }) => (
  <svg className={className} fill="none" stroke="currentColor" viewBox="0 0 24 24" style={{width: '1em', height: '1em', display: 'inline', verticalAlign: 'middle'}}>
...
// Member List Icon
export const MemberListIcon = ({ className = "w-5 h-5" }) => (
  <svg className={className} fill="none" stroke="currentColor" viewBox="0 0 24 24" style={{width: '1em', height: '1em', display: 'inline', verticalAlign: 'middle'}}>
...
// Dependents Icon
export const DependentsIcon = ({ className = "w-5 h-5" }) => (
  <svg className={className} fill="none" stroke="currentColor" viewBox="0 0 24 24" style={{width: '1em', height: '1em', display: 'inline', verticalAlign: 'middle'}}>
...
// Surveys Icon
export const SurveysIcon = ({ className = "w-5 h-5" }) => (
  <svg className={className} fill="none" stroke="currentColor" viewBox="0 0 24 24" style={{width: '1em', height: '1em', display: 'inline', verticalAlign: 'middle'}}>
...
// File Upload Icon
export const FileUploadIcon = ({ className = "w-5 h-5" }) => (
  <svg className={className} fill="none" stroke="currentColor" viewBox="0 0 24 24" style={{width: '1em', height: '1em', display: 'inline', verticalAlign: 'middle'}}>
...
// Notices Icon
export const NoticesIcon = ({ className = "w-5 h-5" }) => (
  <svg className={className} fill="none" stroke="currentColor" viewBox="0 0 24 24" style={{width: '1em', height: '1em', display: 'inline', verticalAlign: 'middle'}}>
...
// Help Center Icon
export const HelpCenterIcon = ({ className = "w-5 h-5" }) => (
  <svg className={className} fill="none" stroke="currentColor" viewBox="0 0 24 24" style={{width: '1em', height: '1em', display: 'inline', verticalAlign: 'middle'}}>
    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 18h.01M12 14a4 4 0 10-4-4m4 8v-4m0-4a4 4 0 014-4" />
  </svg>
);

// Banner Icon
export const BannerIcon = ({ className = "w-5 h-5" }) => (
  <svg className={className} fill="none" stroke="currentColor" viewBox="0 0 24 24" style={{width: '1em', height: '1em', display: 'inline', verticalAlign: 'middle'}}>
    <path
      strokeLinecap="round"
...
// Temporary Passes Icon
export const TemporaryPassesIcon = ({ className = "w-5 h-5" }) => (
  <svg className={className} fill="none" stroke="currentColor" viewBox="0 0 24 24" style={{width: '1em', height: '1em', display: 'inline', verticalAlign: 'middle'}}>
    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z" />
